/*
 * ISI Custom Board Configuration (OpenMV N6 Based)
 * Based on OPENMV_N6/omv_boardconfig.h
 *
...
// Architecture info
#define OMV_BOARD_ARCH                      "ISI Ranger N6" // 33 chars max
...
// CSI sensor drivers (enabled for ISI Ranger)
